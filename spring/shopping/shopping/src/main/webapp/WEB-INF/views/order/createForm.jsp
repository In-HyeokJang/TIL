...
<div class="container">
  ...
  <h3>배송 정보</h3>
  <ul class="list-group">
	<li class="list-group-item">주문자:${mdto.mname} / 전화번호:${mdto.tel}
  ...
  <ul class="list-group">
	...
	<input type="radio" class="btn-check" name="payment" value="카카오뱅크" id="btn2" >
	<label class="btn btn-primary" for="btn2">카카오뱅크</label>
	<input type="radio" class="btn-check" name="payment" value="네이버pay" id="btn3">
	<label class="btn btn-primary" for="btn3">네이버pay</label>
...
<form id="oform" method="post">
	<input type="hidden" name="cno" value="${con}">
