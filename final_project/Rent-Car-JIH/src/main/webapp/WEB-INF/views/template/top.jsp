...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <c:when test="${empty sessionScope.id }">
        <li><a href="${root}/carinfo/create"><span class="glyphicon glyphicon-plus-sign"></span> 자동차등록</a></li>
        <li><a href="${root}/carinfo/list"><span class="glyphicon glyphicon-list"></span> 자동차목록</a></li>
