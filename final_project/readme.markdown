...
- user 권한 접근 세션 추가
- settime 100 -> 10 으로 설정 변경
- 아쉬운점... kakao mpa 위도 경도 자동화 시키지 못한점..
- 잘한점 .. 디비 모델링 쿼리 설계, 디자인 완성도, 디자인 느낌

#### 220816

- 주말 연휴 쉬면서 ppt 완성
- 코드 리뷰 or 사진만으로 설명 ppt 2가지 방식으로 완성
- 전체 병합 중이고, 수정은 이제 team main 에서 하기로 함

#### 220818

- 팀 종합 ppt 완성 -> 강사님 피드백 후 수정 필요
- 개인 포토플리오 github작성완료
- 개인 ppt 포토플리오 아직 미완성
- 내일 마지막 수업
- 인턴 제의 받은거 한번 더 확인 후 내일 최종 보고
